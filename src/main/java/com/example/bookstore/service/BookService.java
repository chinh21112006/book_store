...
public class BookService {
    ...
    // New method to get newest books
    ...
    public void initData() {
        ...
        if (categoryService.getAllCategories().isEmpty()) {
            categoryService.saveCategory(new Category("Văn học cổ điển", "https://lh3.googleusercontent.com/aida-public/AB6AXuAAfLWWJQ5La_pSeD91fSdGCXdReLkfJFW2TxtQMUS7T1PAa77HiDd8zgxSS192j3AO-2vUK-VYTn2Ip-CTSjww51WkV5phE1tT2ufczD1DSEWk5wend8spzj_gPti6m9LTU8dbDbjwrd6DgrR8Gkh91K9FdsJiYPYl_nkxlAQNDL64LHR57MQgDpND7LyCLSc7M7pxw962iDsPXAHWmaatulMYJ5gAVlIE6KCp0XKGedOiX7iGWV75pj9P3YeMt9XD3u6QsZBcDcG", "Những tác phẩm kinh điển vượt thời gian."));
        ...
        if (bookRepository.count() == 0) {
            bookRepository.save(new Book("Bản Đồ Thiên Hà", elenaVance, 245000.0, 320000.0, "https://lh3.googleusercontent.com/aida-public/AB6AXuA7wrUg_LnHQo_RDmPALIuNYdoHFGujYAKoh4CntkYmkAfH4F4n42WzSL5RNOSG76ISD-GV36npUZnVFfe0p3LqVtaAYgGL3CT147VE4TBkFg2SQ0sIP8A8OyGIq-u8xdoQ_maKQoHiRLTI9K2MCVEsWr4P92trylgZZ7tG6FoZYl42OuAIP1rbfTtFM3PgYhwvRG-Q2Z7qIi4iagOjiPf6u-mxzibqoT96AgH5-mQTfZGTj0nEvWEjesFNCceHlXOH0It2xuCP8D2", "Một cuộc phiêu lưu xuyên không gian đầy kịch tính và bất ngờ.", classic));
