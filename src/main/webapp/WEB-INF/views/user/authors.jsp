...
<head>
    ...
    <title>Danh Sách Tác Giả | The Digital Atelier</title>
    <script src="https://cdn.tailwindcss.com?plugins=forms,container-queries"></script>
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,400;0,700;1,400&amp;family=Be+Vietnam+Pro:wght@300;400;500;700&amp;display=swap" rel="stylesheet"/>
...
<body class="min-h-screen flex flex-col">
    <!-- TopNavBar -->
    <header class="bg-surface/90 backdrop-blur-md sticky top-0 z-50 transition-all duration-300">
        <div class="flex justify-between items-center w-full px-8 py-6 max-w-screen-2xl mx-auto">
            <a class="font-headline text-2xl font-bold text-primary tracking-tight" href="${pageContext.request.contextPath}/home">The Digital Atelier</a>
            <nav class="hidden md:flex items-center space-x-8">
                ...
                <a class="text-on-surface-variant font-medium hover:text-primary transition-colors" href="${pageContext.request.contextPath}/categories">Chủ Đề Sách</a>
                <a class="text-primary font-bold border-b-2 border-primary pb-1 transition-all" href="${pageContext.request.contextPath}/authors">Tác Giả</a>
            </nav>
            <div class="flex items-center space-x-6">
                <div class="relative hidden lg:block">
                    <input class="bg-surface-container-high border-none rounded-lg py-2 pl-4 pr-10 focus:ring-1 focus:ring-primary text-label-md font-body w-64" placeholder="Tìm kiếm tác phẩm..." type="text"/>
                    <span class="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 text-on-surface-variant">search</span>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="${pageContext.request.contextPath}/cart" class="p-2 hover:bg-primary-container/20 rounded-lg transition-all duration-300 scale-95 active:scale-90">
                        <span class="material-symbols-outlined text-primary">shopping_cart</span>
                    </a>
                    <button class="p-2 hover:bg-primary-container/20 rounded-lg transition-all duration-300 scale-95 active:scale-90">
    ...
    <!-- Footer -->
    <footer class="bg-surface-container-low dark:bg-surface-container-low mt-auto border-t-0">
        <div class="flex flex-col items-center justify-center w-full py-16 px-8 text-center max-w-screen-2xl mx-auto">
            <div class="font-headline text-xl text-primary mb-4">The Digital Atelier</div>
            <div class="flex flex-wrap justify-center gap-8 mb-8">
                <a class="text-on-surface-variant hover:text-primary font-body text-label-lg transition-all" href="#">Về Chúng Tôi</a>
                <a class="text-on-surface-variant hover:text-primary font-body text-label-lg transition-all" href="#">Chính Sách Giao Hàng</a>
                <a class="text-on-surface-variant hover:text-primary font-body text-label-lg transition-all" href="#">Điều Khoản Dịch Vụ</a>
                <a class="text-on-surface-variant hover:text-primary font-body text-label-lg transition-all" href="#">Câu Hỏi Thường Gặp</a>
            </div>
            <div class="flex gap-6 mb-8">
                <button class="w-10 h-10 rounded-full bg-surface-container-lowest flex items-center justify-center text-primary hover:opacity-80 transition-opacity">
            ...
            <p class="font-body text-label-lg leading-relaxed text-on-surface-variant opacity-70">© 2024 The Digital Atelier. Nơi những tâm hồn yêu sách tìm thấy nơi trú ẩn.</p>
        </div>
    </footer>
