...
<head>
    ...
    <title>${category.name} | The Digital Atelier</title>
        ...
        <nav class="flex justify-between items-center w-full px-12 py-6 max-w-[1440px] mx-auto">
            <div class="flex items-center gap-12">
                ...
                <div class="hidden md:flex gap-8">
                    ...
                    <a class="text-[#934b19] border-b-2 border-[#934b19] pb-1 font-serif font-bold text-xl cursor-pointer" href="${pageContext.request.contextPath}/categories">Chủ Đề</a>
